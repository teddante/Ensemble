...
class TestConfigFallback(unittest.TestCase):
    ...
    def test_only_default_env_exists(
        self, mock_dotenv_values, mock_path, mock_find_dotenv
    ):
        # Setup mocks
    ...
    def test_both_env_files_exist(
        self, _mock_load_dotenv, mock_dotenv_values, mock_path, mock_find_dotenv
    ):
        # Setup mocks
        ...
        )  # Not in user .env, should use default
