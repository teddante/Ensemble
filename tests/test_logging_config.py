...
from logging_config import (CorrelationIDFilter, EnsembleLogger,
                            HumanReadableFormatter, JSONFormatter,
                            LoggingContext, clear_context, get_context,
                            get_logger, log_performance, reset_logging,
                            set_correlation_id, set_request_id, setup_logging)
...
class TestLoggingSetup(unittest.TestCase):
    ...
    def test_setup_logging_with_parameters(self):
        ...
        try:
            setup_logging(level="DEBUG", log_format="json", log_file=temp_file_path)
...
class TestPerformanceLogger(unittest.TestCase):
    ...
    def test_log_performance_with_exception(self, mock_time):
        ...
        with patch("logging_config.get_logger") as mock_get_logger:
            ...
            self.assertAlmostEqual(error_call[1]["extra"]["duration_seconds"], 0.3, places=1)
