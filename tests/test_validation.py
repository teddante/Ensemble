...
from validation import (PYDANTIC_AVAILABLE, EnsembleConfig,
                        ModelConfigValidationError, PromptValidationError,
                        sanitize_prompt, validate_file_path,
...
class TestEnsembleConfig(unittest.TestCase):
    ...
    def test_valid_config(self):
        ...
        self.assertEqual(
            ...
            "sk-test-key-123456789abcdef456789abcdef-123456789abcdef",
        )
...
class TestFallbackValidation(unittest.TestCase):
    ...
    def test_basic_config_creation(self):
        ...
        config = EnsembleConfig(**config_data)
        self.assertEqual(
            config.openrouter_api_key, "sk-test-key-123456789abcdef456789abcdef-123"
        )
    ...
    def test_config_dict_method(self):
        ...
        self.assertEqual(
            config_dict["openrouter_api_key"], "sk-test-key-123456789abcdef"
        )
