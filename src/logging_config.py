...
class CorrelationIDFilter(logging.Filter):
    ...
    def filter(self, record):
        ...
        record.correlation_id = getattr(_request_context, 'correlation_id', 'no-correlation-id')
...
class EnsembleLogger:
    ...
    def setup_logging(self, 
        ...
        log_format = log_format or os.getenv('LOG_FORMAT', 'json' if env == 'production' else 'human')
...
def setup_logging(level: str = None, 
    ...
    Args:
        ...
        backup_count: Number of backup files to keep
    """
    _ensemble_logger.setup_logging(level, log_format, log_file, enable_rotation, max_file_size, backup_count)
